...
#define Goal_x  7
#define Goal_y  7
#define Goal_angle 3 //ゴールした直後の向き スタートの向きが17
...
#define s45 (775)		//45度１マス直進 タイヤ削れた時：800
#define h1 (515)		//半マス直進 	タイヤ削れた時：525　最短用
#define h1_2 (520)		//半マス直進 	タイヤ削れた時：525  探索の壁切れ用

#define s45_V2 (120)	//140	//２マスVターンの距離　壁切れができない可能性が高いので実質距離で調整する
#define s45_V2_out (200)	//２マスVターンの距離　壁切れができない可能性が高いので実質距離で調整する
#define s45_V2_out_LR (100)	//２マスVターンの距離　壁切れができない可能性が高いので実質距離で調整する　壁切れ後にカーブ
...
#define rslsl90_BIG (1740)	//スラローム 大 タイヤ削れた時：1600  1700
#define rslsl90_BIG_offset  (-250)	      //タイヤ削れた時：-100	
#define rslsr90_BIG (1740)	//スラローム 大 タイヤ削れた時：1600  1700
#define rslsr90_BIG_offset  (-250)	      //タイヤ削れた時：-100

#define usll180     (2280)	//Uターン 2240
#define usll180_fin (-10)	//Uターン 微調整
#define uslr180     (2280)	//Uターン 2240
