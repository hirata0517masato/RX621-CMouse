 ...
 *                              - FLASH_MCU_xxxxx (xxxxx is 'RX610' etc)
 *                              - FLASH_API_RX_CFG_ICLK_HZ
 *                              - FLASH_API_RX_CFG_FCLK_HZ
 *                              - FLASH_API_RX_CFG_ROM_SIZE_BYTES
 *                              - FLASH_API_RX_CFG_DATA_FLASH_SIZE_BYTES
 *                              - SIZE_xxx (xxx is '2MB" etc)
 ******************************************************************************/

#ifndef FLASH_API_CONFIG_H
#define FLASH_API_CONFIG_H
...
/* Device Select.
   Enable the definition of the device to use.
*/
//#define FLASH_MCU_RX210
//#define FLASH_MCU_RX21A
//#define FLASH_MCU_RX220
//#define FLASH_MCU_RX610
//#define FLASH_MCU_RX62G
#define FLASH_MCU_RX621
//#define FLASH_MCU_RX62N
//#define FLASH_MCU_RX62T
//#define FLASH_MCU_RX630
//#define FLASH_MCU_RX631
//#define FLASH_MCU_RX63N
//#define FLASH_MCU_RX63T

/* System Clock (ICLK).
   Specifies the frequency of the system clock (ICLK) in Hz.
*/
#define FLASH_API_RX_CFG_ICLK_HZ  (96000000)

/* Flash IF Clock (FCLK) or Peripheral Clock (PCLK).
   RX610 Group or RX62x Group:
     Specifies the frequency of the peripheral module clock (PCLK) in Hz.
   RX63x Group or RX2x Group:
     Specifies the frequency of the FlashIF clock (FCLK) in Hz.
*/
#define FLASH_API_RX_CFG_FCLK_HZ  (24000000)


/* ROM & DataFlash Memory Size.
   Specifies the ROM and DataFlash memory size in bytes.
   A macro definition (SIZE_xB) can also be used to specify the size.
*/
#define FLASH_API_RX_CFG_ROM_SIZE_BYTES        (SIZE_512KB)
#define FLASH_API_RX_CFG_DATA_FLASH_SIZE_BYTES (SIZE_32KB)


/* Memory Size Definition (don't change)*/
#define SIZE_2MB     (2097152)
#define SIZE_1M512KB (1572864)
#define SIZE_1MB     (1048576)
#define SIZE_768KB   (786432)
#define SIZE_512KB   (524288)
#define SIZE_384KB   (393216)
#define SIZE_256KB   (262144)
#define SIZE_128KB   (131072)
#define SIZE_96KB    (98304)
#define SIZE_64KB    (65536)
#define SIZE_48KB    (49152)
