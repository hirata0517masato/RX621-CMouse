...
#ifndef FLASH_API_RX_PRIVATE_H
#define FLASH_API_RX_PRIVATE_H
...
#if !defined(FLASH_API_RX_CFG_ICLK_HZ)
    #error "ERROR !!! You must specify the System Clock Frequency (FLASH_API_RX_CFG_ICLK_HZ)!"
#endif
...
#define ROM_PE_ADDR     ((0x100000000 - FLASH_API_RX_CFG_ROM_SIZE_BYTES)&(0x00FFFFFF))
