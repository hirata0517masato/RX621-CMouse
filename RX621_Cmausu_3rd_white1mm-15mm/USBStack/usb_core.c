...
static USB_ERR ProcessStandardSetupPacket(uint16_t* _pNumBytes,
										  uint8_t** _ppBuffer);
static USB_ERR ProcessGetDescriptor(uint16_t* _pNumBytes,
...
*				  _fpCBError: Function that will be called when an unhandles error
*							  occours.
