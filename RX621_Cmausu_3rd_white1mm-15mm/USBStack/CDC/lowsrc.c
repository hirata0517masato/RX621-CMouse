...
/******************************************************************************
* Outline 		: _INIT_IOLIB
* Description 	: Initialize C library Functions, if necessary. Define
*				  USES_SIMIO on Assembler Option.
* Argument  	: none
* Return value  : none
******************************************************************************/
...
* Argument  	: const char* or char*
*				  long or int
*				  long or int
* Return value  : long or int
******************************************************************************/
#if defined( __RX )
...
#endif
{
       ...
       /* Checking the file mode with the file number, each character is input
...
* Argument  	: long or (int) fileno -
*				  long offset -
*				  long or (int) base -
* Return value  : long - returns (-1)
******************************************************************************/
#if defined( __RX )
...
/*
Function Name: 	abort
Description:	Required by standard lib. when using assert.
Parameters: 	none
Return value: 	none
*/
...
void abort(void)
{
	printf("program is abort !!¥n");	// メッセージを出力します
