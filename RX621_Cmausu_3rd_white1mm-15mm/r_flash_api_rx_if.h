...
#ifndef FLASH_API_RX_H
#define FLASH_API_RX_H
...
#define RX_FLASH_API_VERSION_MAJOR           (3)
#define RX_FLASH_API_VERSION_MINOR           (00)
...
/* 'size' parameter for R_FlashDataAreaBlankCheck. This macro should be used
 * in place of the deprecated macros BLANK_CHECK_8_BYTE & BLANK_CHECK_2_BYTE.
