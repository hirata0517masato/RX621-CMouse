...
*
* Copyright (C) 2012-2022 Renesas Electronics Corporation. All rights reserved.
*******************************************************************************/
/******************************************************************************
* File Name    : r_flash_api_rx62n.h
...
*         : 12.09.2013 1.20    Added DF_BLOCK_SIZE_LARGE macro.
*         : 14.02.2022 1.30    Added a include header file 'r_flash_api_rx_config.h'.
*                              Changed BSP_ROM_SIZE_BYTES to FLASH_API_RX_CFG_ROM_SIZE_BYTES.
*                              Removed FLASH_CLOCK_HZ macro definition.
*                              Changed FLASH_CLOCK_HZ to FLASH_API_RX_CFG_FCLK_HZ.
*                              Changed the reference value of waiting time in FCU processing.
******************************************************************************/

#ifndef FLASH_API_RX62N_H
#define FLASH_API_RX62N_H
...
/* Defines Flash API configuration. */
...
/* This is the same thing as DF_ERASE_BLOCK_SIZE for RX62x and RX610 MCUs. */
...
#if FLASH_API_RX_CFG_ROM_SIZE_BYTES == 524288
    #define ROM_NUM_BLOCKS      38    //512KB part
#elif FLASH_API_RX_CFG_ROM_SIZE_BYTES == 393216
    #define ROM_NUM_BLOCKS      30    //384KB part
#elif FLASH_API_RX_CFG_ROM_SIZE_BYTES == 262144
    #define ROM_NUM_BLOCKS      22    //256KB part
#else
    #error "ERROR - Flash API - !!! No ROM size for this MCU Group !!!"
#endif
...
#endif /* FLASH_BLOCKS_DECLARE */


/*  According to HW Manual the Max Programming Time for 256 bytes (ROM)
    is 14.4ms.  This is with a PCLK of 50MHz. The calculation below
    calculates the number of ICLK ticks needed for the timeout delay.
    The 14.4ms number is adjusted linearly depending on the PCLK frequency.
*/
#define WAIT_MAX_ROM_WRITE \
        ((int32_t)(14400 * (50.0/(FLASH_API_RX_CFG_FCLK_HZ/1000000)))*(FLASH_API_RX_CFG_ICLK_HZ/1000000))
...
#define WAIT_MAX_DF_WRITE \
        ((int32_t)(5000 * (50.0/(FLASH_API_RX_CFG_FCLK_HZ/1000000)))*(FLASH_API_RX_CFG_ICLK_HZ/1000000))
...
#define WAIT_MAX_BLANK_CHECK \
        ((int32_t)(700 * (50.0/(FLASH_API_RX_CFG_FCLK_HZ/1000000)))*(FLASH_API_RX_CFG_ICLK_HZ/1000000))
...
#define WAIT_MAX_NOTIFY_FCU_CLOCK \
        ((int32_t)(60 * (50.0/(FLASH_API_RX_CFG_FCLK_HZ/1000000)))*(FLASH_API_RX_CFG_ICLK_HZ/1000000))

/*  According to HW Manual the Max Erasure Time for a 16kB block is
    around 288ms.  This is with a PCLK of 50MHz. The calculation below
    calculates the number of ICLK ticks needed for the timeout delay.
    The 288ms number is adjusted linearly depending on the PCLK frequency.
*/
#define WAIT_MAX_ERASE \
        ((int32_t)(288000 * (50.0/(FLASH_API_RX_CFG_FCLK_HZ/1000000)))*(FLASH_API_RX_CFG_ICLK_HZ/1000000))

/******************************************************************************
Error checking
******************************************************************************/
/* PCLK must be between 8MHz and 50MHz. */
#if (FLASH_API_RX_CFG_FCLK_HZ > 50000000) || (FLASH_API_RX_CFG_FCLK_HZ < 8000000)
    #error "ERROR - Flash API - PCLK on RX62N must be between 8MHz and 50MHz!"
#endif

#endif /* FLASH_API_RX62N_H */
